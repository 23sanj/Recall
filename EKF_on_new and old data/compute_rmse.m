function [rmse] = compute_rmse(x0,V0,A,B,M_list,R_list,Q,R,n_backs_list,data_list,subList,a)
...
for k = 1:nSubs
    ...
    Rt=R_list{k};
    dim=1;
    [xf,Vf,Pf,loglik,G_t,err,Predicted_Values] = ekalman_filter(A,B,u,Q,R,y,x0,V0,dim,M,Rt,a);
