...
if nargin == 0 
DataDir = '/Users/sanjana/Documents/MATLAB/GameplayData/UCR-UCI Data Cleaned/CleanedData/RLB/'; % Directory name
...
for i=1:5 %Random Restarts to avoid getting stuck in local maxima
    [A, B, Q,R x0, V0, loglik] = learn_kalman(data_list,n_backs_list,M_list,R_list,dim);
