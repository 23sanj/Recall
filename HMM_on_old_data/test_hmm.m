...
DataDir = '/Users/sanjana/Documents/MATLAB/GameplayData/Conditions/3 Recall(NonHoldout)/'; % Directory name
    ...
    if(subject_name ~= '.') %Check to ensure that hidden files are not open
        ...
        if(isempty(files) == 0)
            ...
            [M,R,n_backs] = set_up2(subList{k});  %Getting the required values from all sessions
             ...
             [Y_hat,residuals]= forward2(Pi,B,A,R,M);
...
/home/csgrads/ssand024/Desktop/n-back/GameplayData/Conditions/2 Tapback (Active Control)/