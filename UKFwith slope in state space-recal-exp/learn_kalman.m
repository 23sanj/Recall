...
function [A, B, Q, R,x0, V0, loglik] = learn_kalman(data,n_backs,M_list,R_list,LL,A_L,B_L,Q_L,R_L,x0_L,V0_L,dim)
...
Sum_ub = zeros(1, dim);
  ...
  for s = 1:N
    ...
    [S_xx,S_xb,S_bb,S_yy,S_yx,S_yu,S_xu1,S_bu,S_uu1,S_uu2,S_xu2,S_bx,S_xy,S_uy,S_ux1,S_ux2,S_ub,S_yg,S_yg2,x1_t,V1_t,loglik_t] = Estep(A,B,u,Q,R,y,x0,V0,M,Rt,dim);
    Sum_xx = Sum_xx + S_xx;
    Sum_xb = Sum_xb + S_xb;
    Sum_bb = Sum_bb + S_bb;
    Sum_yy = Sum_yy + S_yy;
